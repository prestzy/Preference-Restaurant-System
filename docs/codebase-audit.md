...
| Security | A debug `admin/admin` fallback exposed a predictable account. | Critical | Admin credential resolution. | Removed; explicit environment credentials required. | admin handler, README |
